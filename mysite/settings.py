...
SECRET_KEY = "e2#e55-yf!m+@35w3(vsb*3gsv2y3et#{SECRET_KEY}6y+u*%3o*8vihta0f#{SECRET_KEY}"
...
MIDDLEWARE = [
    ...
    'mysite.middleware.force_default_middleware.force_default_language_middleware',
...
if PROD:  # For production docker use
    ...
    #         'NAME': 'news_db_name',
    #         'USER': 'news_db_user',
    #         'PASSWORD': '8574gujfiwekd7wh4r6hseaifmkdmf3u4fneurygnrjg',
    #         'HOST': 'localhost',
    #         'PORT': '5432',
    #     }
    # }
