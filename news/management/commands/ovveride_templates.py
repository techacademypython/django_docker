...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if os.path.exists(venv_path):
            subprocess.call("rm -rf $(pwd)/news/templates/* && cp -r {}/lib/python{}/site-packages/oscar/templates/oscar/* $(pwd)/news/templates && cd news/templates && tree".format(venv_path, PYTHON_VERSION),shell=True)
